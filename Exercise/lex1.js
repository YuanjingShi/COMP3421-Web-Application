var canvas = document.getElementById('canvas'), context = canvas.getContext('2d'), FONT_HEIGHT = 15, MARGIN = 35,
HAND_TRUNCATION = canvas.width/25,
HOUR_HAND_TRUNCATION = canvas.width/10, NUMERAL_SPACING = 20, 
...
: RADIUS - HAND_TRUNCATION; context.moveTo(canvas.width/2, canvas.height/2);
...
function drawClock() { context.clearRect(0,0,canvas.width,canvas.height);
